...
| `@sqlanvil/core` | `1.8.3` | 2026-06-24 | real (`latest`) — MySQL pre/post-ops (#44) + DuckDB → `@duckdb/node-api` security migration (#40) |
| `@sqlanvil/cli` | `1.8.3` | 2026-06-24 | real (`latest`) — MySQL pre/post-ops (#44) + DuckDB → `@duckdb/node-api` security migration (#40) |
...
published version of both packages is **`1.8.3`** (`latest`).
