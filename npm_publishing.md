...
| `@sqlanvil/core` | `1.8.0` | 2026-06-18 | real (`latest`) — `type:"export"` file exports |
| `@sqlanvil/cli` | `1.8.0` | 2026-06-18 | real (`latest`) — `type:"export"` file exports (+ duckdb dep) |
...
published version of both packages is **`1.8.0`** (`latest`).
