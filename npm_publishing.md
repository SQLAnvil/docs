...
| both | `1.25.2` | 2026-07-25 | real (`latest`) — validate self-reference fix (#49): self() → production relation; ops dry-run against fresh stub (BQ); PG no longer EXPLAINs DDL ops |
...
published version of both packages is **`1.25.2`** (`latest`).
